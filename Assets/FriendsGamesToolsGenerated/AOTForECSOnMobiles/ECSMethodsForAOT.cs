...
namespace FriendsGamesTools.ECSGame.DataMigration
{
    public class ECSMethodsForAOT
    {
        public void CallECSMethods()
        {
            ...
            manager.SetComponentData(e, manager.GetComponentData<DrawSpell.RateUsData>(e));
            manager.AddComponent<DrawSpell.RateUsData>(e);
            manager.AddComponentData<DrawSpell.RateUsData>(e, manager.GetComponentData<DrawSpell.RateUsData>(e));
            manager.HasComponent<DrawSpell.RateUsData>(e);
