...
namespace DrawSpell
{
    public class DrawSpellAdsManager
#if ADS
    : AdsManager<DrawSpellAdsManager>
#else
    : MonoBehaviour
#endif
    {
        ...
        public void ShowRewarded(string nameInAnalytics, Action onSuccess)
        {
            ...
            HCAnalyticsManager.OnAdPressed(AdType.RewardedVideo, nameInAnalytics, DrawSpellAdsManager.instance.rewarded.available);
