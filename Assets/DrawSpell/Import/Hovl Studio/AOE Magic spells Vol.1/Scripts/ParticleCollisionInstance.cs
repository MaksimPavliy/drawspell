...
public class ParticleCollisionInstance : MonoBehaviour
{
    ...
    {      
        ...
        for (int i = 0; i < numCollisionEvents; i++)
        {
            ...
            {
                var instance = Instantiate(effect, collisionEvents[i].intersection + collisionEvents[i].normal * Offset, new Quaternion(), spellEffects) as GameObject;
