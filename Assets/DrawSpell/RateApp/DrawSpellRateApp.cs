...
namespace DrawSpell
{
    ...
    public class DrawSpellRateApp : Controller
    {
        ...
        private bool LastGameIsWin => root.Get<DrawSpellLevelsController>().LastGameIsWin; //set it manually on each win or lose
